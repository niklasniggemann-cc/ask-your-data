...
- **2026-09-16** — **Unity Gateway API and developer tools reach GA** — CRUDL management of model services, model provider services, and MCP services is now generally available across Terraform, the Databricks CLI, and the Python/Go/Java/JS SDKs, letting teams provision and version AI governance as code rather than only through the UI. [Source](https://docs.databricks.com/aws/en/release-notes/product/2026/september)
