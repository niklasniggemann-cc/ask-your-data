...
- **2026-09-09** — **Branch and edit chats**: fork a conversation into a new independent thread from any Genie Code message, ask a quick side question with `/btw` without joining it to the thread, or edit an earlier message to rewind and regenerate the chat from that point. [Source](https://docs.databricks.com/aws/en/genie-code/branch)
